...
| 파일 | 원본 | 제작 | 라이선스 |
|---|---|---|---|
| textures/oak_veneer_01_* | [Poly Haven – Oak Veneer 01](https://polyhaven.com/a/oak_veneer_01) | Jenelle van Heerden | CC0 |
| hdri/studio_small_09_1k.hdr | [Poly Haven – Studio Small 09](https://polyhaven.com/a/studio_small_09) | Sergej Majboroda | CC0 |
| audio/pickup.ogg (glass_001) | [Kenney – Interface Sounds](https://kenney.nl/assets/interface-sounds) | Kenney | CC0 |
| audio/fall.ogg (impactWood_heavy_000) | [Kenney – Impact Sounds](https://kenney.nl/assets/impact-sounds) | Kenney | CC0 |
...
> 한글 폰트는 용량을 줄이려고 `localization/strings.csv`에 쓰인 글자만 남겼다.
> 새 한글 문장을 추가하면 Jua-Regular.ttf에서 다시 subset 해야 글자가 보인다 (fonttools `pyftsubset`).
