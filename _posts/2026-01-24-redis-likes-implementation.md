---
layout: post
title: "좋아요 기능 구현: RDB vs Redis vs 하이브리드"
date: 2026-01-24 11:00:00 +0900
categories: [backend, redis]
---

뉴스 댓글에 좋아요 기능을 추가한다고 가정해봅시다. 실시간 트래픽이 많은 사이트라면 1초에 수만 개의 좋아요가 발생할 수 있습니다. 이런 상황에서 RDB와 Redis 각각의 접근 방식과 하이브리드 아키텍처를 정리합니다.
