---
layout: single
title: "장애는 일상이다 — Sloppy Quorum에서 Merkle Tree까지"
date: 2026-02-16 19:00:00 +0900
categories: [backend, infrastructure]
---

분산 시스템에서 장애는 예외가 아니라 일상이다. 디스크가 고장 나고, 네트워크가 끊기고, 서버가 재시작된다. Dynamo는 이런 상황에서도 서비스를 멈추지 않기 위해 여러 기법을 조합한다.

---

## 먼저 생각해볼 것

3대의 서버에 데이터를 복제하고 있는데, 1대가 죽었다. 쓰기를 실패시켜야 할까?
...
Dynamo의 핵심 아이디어다. 선호 목록의 노드가 죽었으면, **살아있는 다음 노드에 대신 써서 W를 맞춘다.**
