---
layout: post
title: "Redis를 메시지 브로커로 사용하기"
date: 2026-01-24 16:00:00 +0900
categories: [backend, redis]
---

Redis를 메시지 브로커로 쓸 때의 선택지와 한계, 운영 팁을 정리했습니다. "가볍게 알림 보내기"와 "신뢰성 있는 큐/스트림"은 전혀 다른 문제입니다.
...
**주의**: `client-output-buffer-limit pubsub` 초과 시 연결 끊김. 메시지 크기를 작게 유지.
...
### 클러스터
- Redis 7+ **shared pub/sub** 모드로 불필요한 브로드캐스트 감소
